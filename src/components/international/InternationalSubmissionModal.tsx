...
export function InternationalSubmissionModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4 pb-16 sm:pb-0 bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="relative w-full sm:max-w-2xl bg-white dark:bg-[#0B1220] rounded-t-3xl sm:rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[85vh] sm:max-h-[90vh]">
        {/* Header */}
        ...
        {/* Content Body */}
        <div className="p-6 pb-24 sm:pb-6 overflow-y-auto flex-1">
          {errorMsg && (

  ...
  const navGroups: { title: string; items: PartnerNavItem[] }[] = [
    {
      ...
      items: [
        ...
        { id: 'saved_opportunities', label: 'Saved Opportunities', icon: Bookmark, opType: 'Read/Bookmarks', badge: savedCount },
        { id: 'my_deals', label: 'My Deals', icon: Briefcase, opType: 'Read/Workflow', badge: myDealsCount, badgeColor: 'bg-orange-100 dark:bg-orange-950/60 text-[#FF6A00]' },
        { id: 'leads_referrals', label: 'Leads & Referrals', icon: Users, opType: 'Draft CRUD + Submit', badge: leadsCount, badgeColor: 'bg-blue-100 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300' },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'notifications', label: 'Notifications', icon: Bell, opType: 'Read/Preferences', badge: 2, badgeColor: 'bg-red-100 text-red-700' },
      ],
    },
    {
      title: 'GROW',

  ...
  return [
    {
      ...
      items: [
        ...
        { id: 'discover', label: 'Find Deals', icon: Search, opType: 'Read + Join' },
        ...
        { id: 'leads_referrals', label: 'My Connections', icon: Users, opType: 'Draft CRUD + Submit', badge: leadsCount > 0 ? leadsCount : undefined, badgeColor: 'bg-blue-100 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300' },
      ],
    },
    {
      title: 'PERFORMANCE',

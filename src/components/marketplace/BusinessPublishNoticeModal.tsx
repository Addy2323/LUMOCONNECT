...
export function BusinessPublishNoticeModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-950/70 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl max-w-lg w-full p-5 sm:p-7 shadow-2xl relative space-y-5 sm:space-y-6 max-h-[calc(100dvh-2rem)] overflow-y-auto">
        <button
          onClick={onClose}
